...
impl ObjPhys {
    fn import(source: &mut dyn Read) -> io::Result<Self> {
        Ok(Self {
            ...
            o_xid: source.read_u64::<LittleEndian>()?,
...
impl NxSuperblock {
    fn import(source: &mut dyn Read) -> io::Result<Self> {
        Ok(Self {
            ...
            nx_next_oid: source.read_u64::<LittleEndian>()?,
            nx_next_xid: source.read_u64::<LittleEndian>()?,

            nx_xp_desc_blocks: source.read_u32::<LittleEndian>()?,
            nx_xp_data_blocks: source.read_u32::<LittleEndian>()?,
            nx_xp_desc_base: source.read_i64::<LittleEndian>()?,
            nx_xp_data_base: source.read_i64::<LittleEndian>()?,
            ...
            nx_spaceman_oid: source.read_u64::<LittleEndian>()?,
            nx_omap_oid: source.read_u64::<LittleEndian>()?,
            nx_reaper_oid: source.read_u64::<LittleEndian>()?,

            nx_test_type: source.read_u32::<LittleEndian>()?,

            nx_max_file_systems: source.read_u32::<LittleEndian>()?,
            nx_fs_oid: [0; 100], //[Oid; NX_MAX_FILE_SYSTEMS],
            nx_counters: [0; 32], //[u64; NX_NUM_COUNTERS],
            nx_blocked_out_prange: Prange::import(source)?,
            nx_evict_mapping_tree_oid: source.read_u64::<LittleEndian>()?,
            nx_flags: source.read_u64::<LittleEndian>()?,
            nx_efi_jumpstart: source.read_i64::<LittleEndian>()?,
            nx_fusion_uuid: import_uuid(source)?,
            nx_keylocker: Prange::import(source)?,
            nx_ephemeral_info: [0; 4], //[u64; NX_EPH_INFO_COUNT],

            nx_test_oid: source.read_u64::<LittleEndian>()?,

            nx_fusion_mt_oid: source.read_u64::<LittleEndian>()?,
            nx_fusion_wbc_oid: source.read_u64::<LittleEndian>()?,
